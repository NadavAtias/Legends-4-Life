...
#include "buttons/templateStateButtons.h"
...
void MainMenuState::init()
{
	...
	addButton(std::make_unique<StateButton<LeadboardState>>(StateButton<LeadboardState>({ 1500,150 }, std::string(""), LEAD, sf::Vector2f(1, 1), false, m_statesControl, PUSH)));
